...
#define CONFIG_CS75XX_MAC_TO_EXT_SWITCH 	1
#define CONFIG_CS75XX_GMAC2_TO_EXT_SWITCH 	1
#define CONFIG_CS75XX_PHY_ADDR_GMAC0 		1
#define CONFIG_CS75XX_PHY_ADDR_GMAC1 		5
#define CONFIG_CS75XX_PHY_ADDR_GMAC2 		0
...
#define CONFIG_IDENT_STRING		" FutureTek FTM-100S"
 ...
 */
#define CONFIG_ETHADDR			00.40.5c.12.34.56	/--* talk on MY local MAC address */
#define CONFIG_NETMASK			255.255.255.0		/--* talk on MY local net */
#define CONFIG_IPADDR			192.168.1.222		/--* static IP I currently own */
#define CONFIG_SERVERIP	    	192.168.1.1			/--* current IP of my dev pc */
#define CONFIG_GATEWAYIP		192.168.1.1			/--* current gateway IP */
...
#define CONFIG_SYS_PROMPT		"FTM-100S # "
...
#define CONFIG_SYS_LOAD_ADDR	0x05000000	/* default load address */
