/*
 *  u-boot/drivers/serial/serial_cs752x.h
 *
 ...
 * MA 02111-1307 USA
 */
#ifndef __SERIAL_CS752X_H__
#define __SERIAL_CS752X_H__
...
extern int serial_getc_with_timeout(char *c);
extern void serial_put_hex_no_0x(unsigned int val);
extern void serial_put_decimal(unsigned int val);

#endif /* __SERIAL_CS752X_H__ */
